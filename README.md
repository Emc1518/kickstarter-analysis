...
#### **Limitiations**
The dataset did have limitations because there was a lot of information that was not useful to the purpose of the project and had to be filtered out. It would be helpful to use the Box and Whisker plots to include more larger range of relevant information to make the visualiztions easier to view.
